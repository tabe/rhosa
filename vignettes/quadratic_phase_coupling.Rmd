...
Notice the high values around bifrequencies $(\frac{1.2}{2 \pi}, \frac{0.7}{2 \pi})$
and $(\frac{1.2}{2 \pi}, -\frac{0.7}{2 \pi})$, which are approximately $(0.191,
0.111)$ and $(0.191, -0.111)$, respectively. It means that the QPC in the model
...
Now the pairs of frequencies $(\frac{1.2-0.7}{2 \pi}, -\frac{1.2}{2 \pi})$
and $(\frac{1.2+0.7}{2 \pi}, -\frac{1.2}{2 \pi})$ are in highlights, which are
approximately $(0.080, -0.191)$ and $(0.302, -0.191)$, respectively.
