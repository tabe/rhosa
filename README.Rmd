...
<!-- badges: start -->
[![Build Status](https://travis-ci.com/tabe/rhosa.svg?branch=master)](https://travis-ci.com/tabe/rhosa)
...
This is a simple example, based on the outline at Figure 1 of [2], which
